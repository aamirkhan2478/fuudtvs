...
import { uploadPaidChalan } from "../../../Redux/Actions/chalanAction";
...
const UploadPaidChalan = () => {
  ...
  const clickHandler = (values) => {
    dispatch(uploadPaidChalan(values, id, setNotify, navigate));
  };
  return (
    <>
      ...
      >
        <Card sx={{ boxShadow: 10, width: 400 }}>
          <Container sx={{ display: "flex", justifyContent: "center" }}>
            <Typography variant="h5">Upload Paid Chalan</Typography>
          </Container>
          <Divider />
